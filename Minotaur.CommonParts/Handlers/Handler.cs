...
namespace Minotaur.CommonParts.Handlers
{
    public class Handler : IHandler
	{
        ...
        private Func<MinotaurException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<MinotaurException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (MinotaurException customException)
            {
                isFailure = true;
